...
def drawJunction(h, point, point_type, width, height):
    ...
    ###########################
        ...
        h.plot(
            [x, max(x - lineLength, 0)], [y, y], linewidth=lineWidth, color="#6241c7"
        )
    ...
    ###########################
        ...
        h.plot(
            [x, x], [y, max(y - lineLength, 0)], linewidth=lineWidth, color="#056eee"
        )
        # plt.scatter(x, y+10, c='k')
    ###########################
    #
    ...
    ###########################
        ...
        h.plot(
            [x, max(x - lineLength, 0)], [y, y], linewidth=lineWidth, color="#cdfd02"
        )
        h.plot(
            [x, x],
            [y, min(y + lineLength, height - 1)],
    ...
    ###########################
        ...
        h.plot(
            [x, max(x - lineLength, 0)], [y, y], linewidth=lineWidth, color="#ff81c0"
        )
        h.plot(
            [x, x], [y, max(y - lineLength, 0)], linewidth=lineWidth, color="#ff81c0"
        )
    ###########################
    #
    #  |
    ...
    ###########################
        ...
        h.plot(
            [x, x], [y, max(y - lineLength, 0)], linewidth=lineWidth, color="#f97306"
        )
    ###########################
    #
    # |
    ...
    ###########################
        ...
        h.plot(
            [x, min(x + lineLength, width - 1)], [y, y], linewidth=lineWidth, color="b"
        )
        h.plot([x, x], [y, max(y - lineLength, 0)], linewidth=lineWidth, color="b")
        h.plot(
            [x, x], [y, min(y + lineLength, height - 1)], linewidth=lineWidth, color="b"
        )
    ###########################
    #
    # ---
    ...
    ###########################
        ...
        h.plot(
            [x, min(x + lineLength, width - 1)], [y, y], linewidth=lineWidth, color="y"
        )
        h.plot([x, max(x - lineLength, 0)], [y, y], linewidth=lineWidth, color="y")
        h.plot(
            [x, x], [y, min(y + lineLength, height - 1)], linewidth=lineWidth, color="y"
        )
    ###########################
    #
    #    |
    ...
    ###########################
        ...
        h.plot(
            [x, x], [y, min(y + lineLength, height - 1)], linewidth=lineWidth, color="r"
        )
    ###########################
    #
    #  |
    ...
    ###########################
        ...
        h.plot(
            [x, min(x + lineLength, width - 1)], [y, y], linewidth=lineWidth, color="m"
        )
    ...
    ###########################
        ...
        h.plot(
            [x, max(x - lineLength, 0)], [y, y], linewidth=lineWidth, color="darkred"
        )
        h.plot(
            [x, x],
            [y, min(y + lineLength, height - 1)],
    ...
    ###########################
        ...
        h.plot(
            [x, max(x - lineLength, 0)], [y, y], linewidth=lineWidth, color="orangered"
        )
        h.plot(
            [x, x], [y, max(y - lineLength, 0)], linewidth=lineWidth, color="orangered"
        )
    ...
    for point_type, locations in point_dict.items():
        for loc in locations:
            ...
            ###########################
                ...
                plt.plot(
                    [x, x], [y, max(y - lineLength, 0)], linewidth=lineWidth, color="b"
                )
                plt.plot(
                    [x, x],
                    [y, min(y + lineLength, height - 1)],
            ...
            ###########################
                ...
                plt.plot(
                    [x, max(x - lineLength, 0)], [y, y], linewidth=lineWidth, color="y"
                )
                plt.plot(
                    [x, x],
                    [y, min(y + lineLength, height - 1)],
            ...
            ###########################
                ...
                plt.plot(
                    [x, max(x - lineLength, 0)], [y, y], linewidth=lineWidth, color="r"
                )
                plt.plot(
                    [x, x], [y, max(y - lineLength, 0)], linewidth=lineWidth, color="r"
                )
                plt.plot(
                    [x, x],
                    [y, min(y + lineLength, height - 1)],
            ...
            ###########################
                ...
                plt.plot(
                    [x, max(x - lineLength, 0)], [y, y], linewidth=lineWidth, color="m"
                )
                plt.plot(
                    [x, x], [y, max(y - lineLength, 0)], linewidth=lineWidth, color="m"
                )
            ###########################
            #
            #  |
            ...
            ###########################
                ...
                plt.plot(
                    [x, max(x - lineLength, 0)], [y, y], linewidth=lineWidth, color="k"
                )
                plt.plot(
                    [x, x], [y, max(y - lineLength, 0)], linewidth=lineWidth, color="k"
                )
                plt.plot(
                    [x, x],
                    [y, min(y + lineLength, height - 1)],
